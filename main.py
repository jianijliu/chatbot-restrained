...
# image_url = "https://www.caribbeanjobs.com/careeradvice/wp-content/uploads/SalesAssistant-642x336.jpg"
...
if user_id:
    # Accept user input
    if prompt := st.chat_input(placeholder="ask Optima", disabled=st.session_state.disabled, on_submit=disable, max_chars=50):  # 
    ...
    st.markdown("<h3 style='text-align: center;'>(Only one search is allowed with Optima. You have just one chance to ask your questions. \n Ensure your search query is under 50 characters..)</h3>", unsafe_allow_html=True)
